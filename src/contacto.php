...
?>
    ...
    <main class="bg-gray-50 py-12">
        ...
        <div class="container mx-auto px-6 lg:px-8 max-w-3xl">
            <form method="POST"  class="bg-gradient-to-t from-gray-500 to-blue-400 p-8 rounded-lg shadow-xl border border-gray-200">
...
<div class="bg-green-600 p-3  rounded-full fixed bottom-48 right-2  ">
    <a href="https://api.whatsapp.com/send?phone=573213858791&amp:text= Desde Sitio Web BRAYAN HERNANDEZ" class="text-white bg-green-600 p-3  rounded-full fixed bottom-48 right-2  ">
