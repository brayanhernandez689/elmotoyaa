...
<div class="container md:w-5/6 mx-auto px-5 md:px-0 mb-16">
    ...
    <article class="mt-10 border-b-4 pb-8 border-double border-gray-950">
        <div class="flex flex-col-reverse md:flex-row gap-5 md:h-64 lg:h-60">
            ...
            <figure class="md:w-1/2 lg:w-2/3 h-auto">
                <img src="../img/IMG_20241113_124140.jpg" alt="Moto recomendada para ´principiantes" class="object-cover h-full w-full object-center rounded-lg aspect-video"/>
        ...
        <footer>
            <a href="./entrada.php" class="text-xl font-bold hover:px-3 hover:py-2 hover:bg-orange-600 rounded-xl">Leer más...</a>
        </footer>
    </article>
    ...
    <div class="md:grid grid-cols-2 gap-10">
        <article class="mt-16 flex flex-col justify-between border-b-4 pb-8 border-double border-gray-950">
            ...
            <figure>
                <img src="../img/IMG_20241113_124140.jpg" alt="Las mejores motos de 2024" class="w-full h-56 object-cover object-center rounded-md mt-2"/>
                <figcaption>Explora las motos más destacadas del 2024, según tu estilo de conducción.</figcaption>
            </figure>
            <footer>
                <a href="./entrada.php" class="text-xl font-bold hover-px3 hover:py-2 hover:bg-orange-600 rounded-xl">Leer más...</a>
            </footer>
        </article>
